        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeMinimal = table.Column<int>(type: "integer", nullable: false),
                    AgeMaximal = table.Column<int>(type: "integer", nullable: false),
                    ParticipantsMaximal = table.Column<int>(type: "integer", nullable: false),
                    MinimalDurationInMinutes = table.Column<int>(type: "integer", nullable: false),
                    MaximalDurationInMinutes = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseSessions_AspNetUsers_CoachId",
                        column: x => x.CoachId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseSessions_CourseTypes_CourseTypeId",
                        column: x => x.CourseTypeId,
                        principalTable: "CourseTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DogGender = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DogCourseSessions", x => new { x.DogId, x.CourseSessionId });
                    table.ForeignKey(
                        name: "FK_DogCourseSessions_CourseSessions_CourseSessionId",
                        column: x => x.CourseSessionId,
                        principalTable: "CourseSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DogCourseSessions_Dogs_DogId",
                        column: x => x.DogId,
                        principalTable: "Dogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSessions_CoachId",
                table: "CourseSessions",
                column: "CoachId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseSessions_CourseTypeId",
                table: "CourseSessions",
                column: "CourseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_DogCourseSessions_CourseSessionId",
                table: "DogCourseSessions",
